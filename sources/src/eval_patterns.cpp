...
void cEngine::EvaluateBishopPatterns(POS *p, eData *e) {
    ...
    if (p->Bishops(WC) & Mask.wb_special) {
        ...
        if (IsOnSq(p, WC, B, B2)) {
            ...
            if (p->Kings(WC) & Mask.qs_castle[WC]) Add(e, WC, Par.values[B_FIANCH], 0);
        }
        ...
        if (IsOnSq(p, WC, B, G2)) {
            ...
            if (p->Kings(WC) & Mask.ks_castle[WC]) Add(e, WC, Par.values[B_FIANCH], 0);
        }
    }
    ...
    if (p->Bishops(BC) & Mask.bb_special) {
        ...
        if (IsOnSq(p, BC, B, B7)) {
            ...
            if (p->Kings(BC) & Mask.qs_castle[BC]) Add(e, BC, Par.values[B_FIANCH], 0);
        }
        if (IsOnSq(p, BC, B, G7)) {
            ...
            if (p->Kings(BC) & Mask.ks_castle[BC]) Add(e, BC, Par.values[B_FIANCH], 0);
        }
    }
