...
void cParam::DefaultWeights() {  // tuned automatically
	...
	SetVal(d1Knight, -20, -50, 50, true);
	SetVal(e1Knight, -17, -50, 50, true);
	SetVal(f1Knight, -18, -50, 50, true);
	SetVal(g1Knight, -25, -50, 50, true);
	SetVal(h1Knight, -49, -99, 50, true);

	SetVal(a2Knight, -30, -50, 50, true);
	SetVal(b2Knight, -23, -50, 50, true);
	SetVal(c2Knight,  -5, -50, 50, true);
	SetVal(d2Knight,   5, -50, 50, true);
	SetVal(e2Knight,   5, -50, 50, true);
	SetVal(f2Knight,   9, -50, 50, true);
	SetVal(g2Knight,  -4, -50, 50, true);
	SetVal(h2Knight, -12, -50, 50, true);

	SetVal(a3Knight, -19, -50, 50, true);
	SetVal(b3Knight,  -7, -50, 50, true);
	SetVal(c3Knight,   3, -50, 50, true);
	SetVal(d3Knight,  11, -50, 50, true);
	SetVal(e3Knight,  16, -50, 50, true);
	SetVal(f3Knight,   6, -50, 50, true);
	SetVal(g3Knight,  12, -50, 50, true);
	SetVal(h3Knight, -13, -50, 50, true);

	SetVal(a4Knight, -10, -50, 50, true);
	SetVal(b4Knight,   1, -50, 50, true);
	SetVal(c4Knight,   2, -50, 50, true);
	SetVal(d4Knight,   4, -50, 50, true);
	SetVal(e4Knight,  11, -50, 50, true);
	SetVal(f4Knight,  12, -50, 50, true);
	SetVal(g4Knight,  19, -50, 50, true);
	SetVal(h4Knight,  -3, -50, 50, true);

	SetVal(a5Knight,-10, -50, 50, true);
	SetVal(b5Knight,  3, -50, 50, true);
	SetVal(c5Knight,  7, -50, 50, true);
	SetVal(d5Knight, 24, -50, 50, true);
	SetVal(e5Knight, 11, -50, 50, true);
	SetVal(f5Knight, 44, -50, 50, true);
	SetVal(g5Knight,  7, -50, 50, true);
	SetVal(h5Knight, 18, -50, 50, true);
	
	SetVal(a6Knight, -1, -50, 50, true);
	SetVal(b6Knight, 21, -50, 50, true);
	SetVal(c6Knight, 60, -50, 99, true);
	SetVal(d6Knight, 75, -50, 99, true);
	SetVal(e6Knight, 75, -50, 99, true);
	SetVal(f6Knight, 63, -50, 99, true);
	SetVal(g6Knight, 26, -50, 50, true);
	SetVal(h6Knight, 20, -50, 50, true);

	SetVal(a7Knight, -30, -50, 50, true);
	SetVal(b7Knight, -14, -50, 50, true);
	SetVal(c7Knight,  36, -50, 99, true);
	SetVal(d7Knight,  50, -50, 99, true);
	SetVal(e7Knight,  48, -50, 99, true);
	SetVal(f7Knight,  38, -50, 99, true);
	SetVal(g7Knight,  -8, -50, 50, true);
	SetVal(h7Knight, -30, -50, 50, true);

	SetVal(a8Knight, -97, -150, 50, true);
	SetVal(b8Knight, -47, -50, 50, true);
	SetVal(c8Knight,  -7, -50, 50, true);
	SetVal(d8Knight,   5, -50, 50, true);
	...
	SetVal(c1Bish,  -8, -50, 50, true);
	SetVal(d1Bish, -10, -50, 50, true);
	SetVal(e1Bish,  -6, -50, 50, true);
	SetVal(f1Bish, -20, -50, 50, true);
	SetVal(g1Bish,  -5, -50, 50, true);
	SetVal(h1Bish, -13, -99, 50, true);

	SetVal(a2Bish,  -4, -50, 50, true);
	SetVal(b2Bish,   4, -50, 50, true);
	SetVal(c2Bish,   5, -50, 50, true);
	SetVal(d2Bish,  -7, -50, 50, true);
	SetVal(e2Bish,  -1, -50, 50, true);
	SetVal(f2Bish,  11, -50, 50, true);
	SetVal(g2Bish,   4, -50, 50, true);
	SetVal(h2Bish, -11, -50, 50, true);

	SetVal(a3Bish, -9, -50, 50, true);
	SetVal(b3Bish,  4, -50, 50, true);
	SetVal(c3Bish,  4, -50, 50, true);
	SetVal(d3Bish,  0, -50, 50, true);
	SetVal(e3Bish,  5, -50, 50, true);
	SetVal(f3Bish,  4, -50, 50, true);
	SetVal(g3Bish,  8, -50, 50, true);
	SetVal(h3Bish, -1, -50, 50, true);

	SetVal(a4Bish, -3, -50, 50, true);
	SetVal(b4Bish, -6, -50, 50, true);
	SetVal(c4Bish, -3, -50, 50, true);
	SetVal(d4Bish, 15, -50, 50, true);
	SetVal(e4Bish,  7, -50, 50, true);
	SetVal(f4Bish, -7, -50, 50, true);
	SetVal(g4Bish, -6, -50, 50, true);
	SetVal(h4Bish,  9, -50, 50, true);

	SetVal(a5Bish, -9, -50, 50, true);
	SetVal(b5Bish, -7, -50, 50, true);
	SetVal(c5Bish, 14, -50, 50, true);
	SetVal(d5Bish, 16, -50, 50, true);
	SetVal(e5Bish, 16, -50, 50, true);
	SetVal(f5Bish, 15, -50, 50, true);
	SetVal(g5Bish, -7, -50, 50, true);
	SetVal(h5Bish,-11, -50, 50, true);

	SetVal(a6Bish, -2, -50, 50, true);
	SetVal(b6Bish, 31, -50, 50, true);
	SetVal(c6Bish, 33, -50, 99, true);
	SetVal(d6Bish, 19, -50, 99, true);
	SetVal(e6Bish, 19, -50, 99, true);
	SetVal(f6Bish, 41, -50, 99, true);
	SetVal(g6Bish, 31, -50, 50, true);
	SetVal(h6Bish, -2, -50, 50, true);

	SetVal(a7Bish, -6, -50, 50, true);
	SetVal(b7Bish,-14, -50, 50, true);
	SetVal(c7Bish,  3, -50, 99, true);
	SetVal(d7Bish, -16, -50, 99, true);
	SetVal(e7Bish,  -6, -50, 99, true);
	SetVal(f7Bish,   9, -50, 99, true);
	SetVal(g7Bish, -11, -50, 50, true);
	SetVal(h7Bish, -11, -50, 50, true);

	SetVal(a8Bish, -37, -150, 50, true);
	SetVal(b8Bish, -40, -50, 50, true);
	SetVal(c8Bish, -32, -50, 50, true);
	SetVal(d8Bish, -49, -50, 50, true);
	SetVal(e8Bish, -46, -50, 50, true);
	SetVal(f8Bish, -29, -50, 50, true);
...
void cParam::InitialPersonalityWeights() { // tuned manually for good experience of Rodent personalities
    ...
    values[K_NO_LUFT_MG] = -15;
	values[K_NO_LUFT_EG] = -15;
...
void cParam::InitPst() {
	...
	mg_pst[BC][P][D6] = ((values[P_MID] * Par.values[W_MATERIAL]) / 100) + values[d3Pawn];
	mg_pst[WC][P][E3] = ((values[P_MID] * Par.values[W_MATERIAL]) / 100) + values[e3Pawn];
	...
	mg_pst[BC][P][D5] = ((values[P_MID] * Par.values[W_MATERIAL]) / 100) + values[d4Pawn];
	mg_pst[WC][P][E4] = ((values[P_MID] * Par.values[W_MATERIAL]) / 100) + values[e4Pawn];
	...
	mg_pst[BC][P][D4] = ((values[P_MID] * Par.values[W_MATERIAL]) / 100) + values[d5Pawn];
	mg_pst[WC][P][E5] = ((values[P_MID] * Par.values[W_MATERIAL]) / 100) + values[e5Pawn];
	...
	mg_pst[BC][N][B6] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[b3Knight];
	mg_pst[WC][N][G3] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[g3Knight];
	mg_pst[BC][N][G6] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[g3Knight];
	mg_pst[WC][N][H3] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[h3Knight];
	mg_pst[BC][N][H6] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[h3Knight];
	mg_pst[WC][N][A4] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[a4Knight];
	mg_pst[BC][N][A5] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[a4Knight];
	mg_pst[WC][N][B4] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[b4Knight];
	mg_pst[BC][N][B5] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[b4Knight];
	mg_pst[WC][N][G4] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[g4Knight];
	mg_pst[BC][N][G5] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[g4Knight];
	mg_pst[WC][N][H4] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[h4Knight];
	mg_pst[BC][N][H5] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[h4Knight];
	mg_pst[WC][N][A5] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[a5Knight];
	mg_pst[BC][N][A4] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[a5Knight];
	mg_pst[WC][N][B5] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[b5Knight];
	mg_pst[BC][N][B4] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[b5Knight];
	mg_pst[WC][N][G5] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[g5Knight];
	mg_pst[BC][N][G4] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[g5Knight];
	...
	mg_pst[BC][N][D6] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[d3Knight];
	mg_pst[WC][N][E3] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[e3Knight];
	mg_pst[BC][N][E6] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[e3Knight];
	mg_pst[WC][N][F3] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[f3Knight];
	mg_pst[BC][N][F6] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[f3Knight];
	mg_pst[WC][N][C4] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[c4Knight];
	mg_pst[BC][N][C5] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[c4Knight];
	mg_pst[WC][N][D4] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[d4Knight];
	mg_pst[BC][N][D5] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[d4Knight];
	mg_pst[WC][N][E4] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[e4Knight];
	mg_pst[BC][N][E5] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[e4Knight];
	mg_pst[WC][N][F4] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[f4Knight];
	mg_pst[BC][N][F5] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[f4Knight];
	mg_pst[WC][N][C5] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[c5Knight];
	mg_pst[BC][N][C4] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[c5Knight];
	mg_pst[WC][N][D5] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[d5Knight];
	mg_pst[BC][N][D4] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[d5Knight];
	mg_pst[WC][N][E5] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[e5Knight];
	mg_pst[BC][N][E4] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[e5Knight];
	mg_pst[WC][N][F5] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[f5Knight];
	mg_pst[BC][N][F4] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[f5Knight];

	mg_pst[WC][N][A6] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[a6Knight];
	mg_pst[BC][N][A3] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[a6Knight];
	mg_pst[WC][N][B6] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[b6Knight];
	mg_pst[BC][N][B3] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[b6Knight];
	mg_pst[WC][N][C6] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[c6Knight];
	mg_pst[BC][N][C3] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[c6Knight];
	mg_pst[WC][N][D6] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[d6Knight];
	mg_pst[BC][N][D3] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[d6Knight];
	mg_pst[WC][N][E6] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[e6Knight];
	mg_pst[BC][N][E3] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[e6Knight];
	mg_pst[WC][N][F6] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[f6Knight];
	mg_pst[BC][N][F3] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[f6Knight];
	mg_pst[WC][N][G6] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[g6Knight];
	mg_pst[BC][N][G3] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[g6Knight];
	mg_pst[WC][N][H6] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[h6Knight];
	mg_pst[BC][N][H3] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[h6Knight];

	mg_pst[WC][N][A7] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[a7Knight];
	mg_pst[BC][N][A2] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[a7Knight];
	mg_pst[WC][N][B7] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[b7Knight];
	mg_pst[BC][N][B2] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[b7Knight];
	mg_pst[WC][N][C7] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[c7Knight];
	mg_pst[BC][N][C2] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[c7Knight];
	mg_pst[WC][N][D7] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[d7Knight];
	mg_pst[BC][N][D2] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[d7Knight];
	mg_pst[WC][N][E7] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[e7Knight];
	mg_pst[BC][N][E2] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[e7Knight];
	mg_pst[WC][N][F7] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[f7Knight];
	mg_pst[BC][N][F2] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[f7Knight];
	mg_pst[WC][N][G7] = ((values[N_MID] * Par.values[W_MATERIAL]) / 100) + values[g7Knight];
	...
	mg_pst[WC][B][A1] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[a1Bish];
	mg_pst[BC][B][A8] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[a1Bish];
	mg_pst[WC][B][B1] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[b1Bish];
	mg_pst[BC][B][B8] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[b1Bish];
	mg_pst[WC][B][C1] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[c1Bish];
	mg_pst[BC][B][C8] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[c1Bish];
	mg_pst[WC][B][D1] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[d1Bish];
	mg_pst[BC][B][D8] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[d1Bish];
	mg_pst[WC][B][E1] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[e1Bish];
	mg_pst[BC][B][E8] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[e1Bish];
	mg_pst[WC][B][F1] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[f1Bish];
	mg_pst[BC][B][F8] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[f1Bish];
	mg_pst[WC][B][G1] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[g1Bish];
	mg_pst[BC][B][G8] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[g1Bish];
	mg_pst[WC][B][H1] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[h1Bish];
	mg_pst[BC][B][H8] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[h1Bish];

	mg_pst[WC][B][A2] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[a2Bish];
	mg_pst[BC][B][A7] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[a2Bish];
	mg_pst[WC][B][B2] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[b2Bish];
	mg_pst[BC][B][B7] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[b2Bish];
	mg_pst[WC][B][C2] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[c2Bish];
	mg_pst[BC][B][C7] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[c2Bish];
	mg_pst[WC][B][D2] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[d2Bish];
	mg_pst[BC][B][D7] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[d2Bish];
	mg_pst[WC][B][E2] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[e2Bish];
	mg_pst[BC][B][E7] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[e2Bish];
	mg_pst[WC][B][F2] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[f2Bish];
	mg_pst[BC][B][F7] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[f2Bish];
	mg_pst[WC][B][G2] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[g2Bish];
	mg_pst[BC][B][G7] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[g2Bish];
	mg_pst[WC][B][H2] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[h2Bish];
	mg_pst[BC][B][H7] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[h2Bish];

	mg_pst[WC][B][A3] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[a3Bish];
	mg_pst[BC][B][A6] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[a3Bish];
	mg_pst[WC][B][B3] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[b3Bish];
	mg_pst[BC][B][B6] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[b3Bish];
	mg_pst[WC][B][G3] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[g3Bish];
	mg_pst[BC][B][G6] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[g3Bish];
	mg_pst[WC][B][H3] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[h3Bish];
	mg_pst[BC][B][H6] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[h3Bish];
	mg_pst[WC][B][A4] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[a4Bish];
	mg_pst[BC][B][A5] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[a4Bish];
	mg_pst[WC][B][B4] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[b4Bish];
	mg_pst[BC][B][B5] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[b4Bish];
	mg_pst[WC][B][G4] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[g4Bish];
	mg_pst[BC][B][G5] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[g4Bish];
	mg_pst[WC][B][H4] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[h4Bish];
	mg_pst[BC][B][H5] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[h4Bish];
	mg_pst[WC][B][A5] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[a5Bish];
	mg_pst[BC][B][A4] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[a5Bish];
	mg_pst[WC][B][B5] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[b5Bish];
	mg_pst[BC][B][B4] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[b5Bish];
	mg_pst[WC][B][G5] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[g5Bish];
	mg_pst[BC][B][G4] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[g5Bish];
	mg_pst[WC][B][H5] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[h5Bish];
	mg_pst[BC][B][H4] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[h5Bish];

	mg_pst[WC][B][C3] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[c3Bish];
	mg_pst[BC][B][C6] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[c3Bish];
	mg_pst[WC][B][D3] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[d3Bish];
	mg_pst[BC][B][D6] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[d3Bish];
	mg_pst[WC][B][E3] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[e3Bish];
	mg_pst[BC][B][E6] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[e3Bish];
	mg_pst[WC][B][F3] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[f3Bish];
	mg_pst[BC][B][F6] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[f3Bish];
	mg_pst[WC][B][C4] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[c4Bish];
	mg_pst[BC][B][C5] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[c4Bish];
	mg_pst[WC][B][D4] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[d4Bish];
	mg_pst[BC][B][D5] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[d4Bish];
	mg_pst[WC][B][E4] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[e4Bish];
	mg_pst[BC][B][E5] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[e4Bish];
	mg_pst[WC][B][F4] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[f4Bish];
	mg_pst[BC][B][F5] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[f4Bish];
	mg_pst[WC][B][C5] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[c5Bish];
	mg_pst[BC][B][C4] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[c5Bish];
	mg_pst[WC][B][D5] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[d5Bish];
	mg_pst[BC][B][D4] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[d5Bish];
	mg_pst[WC][B][E5] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[e5Bish];
	mg_pst[BC][B][E4] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[e5Bish];
	mg_pst[WC][B][F5] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[f5Bish];
	mg_pst[BC][B][F4] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[f5Bish];

	mg_pst[WC][B][A6] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[a6Bish];
	mg_pst[BC][B][A3] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[a6Bish];
	mg_pst[WC][B][B6] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[b6Bish];
	mg_pst[BC][B][B3] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[b6Bish];
	mg_pst[WC][B][C6] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[c6Bish];
	mg_pst[BC][B][C3] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[c6Bish];
	mg_pst[WC][B][D6] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[d6Bish];
	mg_pst[BC][B][D3] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[d6Bish];
	mg_pst[WC][B][E6] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[e6Bish];
	mg_pst[BC][B][E3] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[e6Bish];
	mg_pst[WC][B][F6] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[f6Bish];
	mg_pst[BC][B][F3] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[f6Bish];
	mg_pst[WC][B][G6] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[g6Bish];
	mg_pst[BC][B][G3] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[g6Bish];
	mg_pst[WC][B][H6] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[h6Bish];
	mg_pst[BC][B][H3] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[h6Bish];

	mg_pst[WC][B][A7] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[a7Bish];
	mg_pst[BC][B][A2] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[a7Bish];
	mg_pst[WC][B][B7] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[b7Bish];
	mg_pst[BC][B][B2] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[b7Bish];
	mg_pst[WC][B][C7] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[c7Bish];
	mg_pst[BC][B][C2] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[c7Bish];
	mg_pst[WC][B][D7] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[d7Bish];
	mg_pst[BC][B][D2] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[d7Bish];
	mg_pst[WC][B][E7] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[e7Bish];
	mg_pst[BC][B][E2] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[e7Bish];
	mg_pst[WC][B][F7] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[f7Bish];
	mg_pst[BC][B][F2] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[f7Bish];
	mg_pst[WC][B][G7] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[g7Bish];
	mg_pst[BC][B][G2] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[g7Bish];
	mg_pst[WC][B][H7] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[h7Bish];
	mg_pst[BC][B][H2] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[h7Bish];

	mg_pst[WC][B][A8] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[a8Bish];
	mg_pst[BC][B][A1] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[a8Bish];
	mg_pst[WC][B][B8] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[b8Bish];
	mg_pst[BC][B][B1] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[b8Bish];
	mg_pst[WC][B][C8] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[c8Bish];
	mg_pst[BC][B][C1] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[c8Bish];
	mg_pst[WC][B][D8] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[d8Bish];
	mg_pst[BC][B][D1] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[d8Bish];
	mg_pst[WC][B][E8] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[e8Bish];
	mg_pst[BC][B][E1] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[e8Bish];
	mg_pst[WC][B][F8] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[f8Bish];
	mg_pst[BC][B][F1] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[f8Bish];
	mg_pst[WC][B][G8] = ((values[B_MID] * Par.values[W_MATERIAL]) / 100) + values[g8Bish];
