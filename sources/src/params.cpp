...
void cParam::DefaultWeights() {  // tuned automatically
	...
	SetVal(a1Bish,  -9, -99, 50, true);
	SetVal(b1Bish,  -1, -99, 50, true);
	SetVal(c1Bish, -14, -50, 50, true);
	SetVal(d1Bish, -12, -50, 50, true);
	SetVal(e1Bish, -12, -50, 50, true);
	SetVal(f1Bish, -14, -50, 50, true);
	SetVal(g1Bish,  -1, -50, 50, true);
	SetVal(h1Bish,  -9, -99, 50, true);

	SetVal(a2Bish,  -5, -50, 50, true);
	SetVal(b2Bish,   2, -50, 50, true);
	SetVal(c2Bish,   5, -50, 50, true);
	SetVal(d2Bish,  -7, -50, 50, true);
	SetVal(e2Bish,  -7, -50, 50, true);
	SetVal(f2Bish,   5, -50, 50, true);
	SetVal(g2Bish,   2, -50, 50, true);
	SetVal(h2Bish,  -5, -50, 50, true);

	SetVal(a3Bish, -8, -50, 50, true);
	SetVal(b3Bish,  7, -50, 50, true);
	SetVal(c3Bish, -2, -50, 50, true);
	SetVal(d3Bish,  1, -50, 50, true);
	SetVal(e3Bish,  1, -50, 50, true);
	SetVal(f3Bish, -2, -50, 50, true);
	SetVal(g3Bish,  7, -50, 50, true);
	SetVal(h3Bish, -1, -50, 50, true);

	SetVal(a4Bish,  3, -50, 50, true);
	SetVal(b4Bish, -7, -50, 50, true);
	SetVal(c4Bish, -2, -50, 50, true);
	SetVal(d4Bish,  9, -50, 50, true);
	SetVal(e4Bish,  9, -50, 50, true);
	SetVal(f4Bish, -2, -50, 50, true);
	SetVal(g4Bish, -7, -50, 50, true);
	SetVal(h4Bish,  3, -50, 50, true);

	SetVal(a5Bish, -8, -50, 50, true);
	SetVal(b5Bish, -1, -50, 50, true);
	SetVal(c5Bish, 20, -50, 50, true);
	SetVal(d5Bish, 22, -50, 50, true);
	SetVal(e5Bish, 22, -50, 50, true);
	SetVal(f5Bish, 20, -50, 50, true);
	SetVal(g5Bish, -1, -50, 50, true);
	SetVal(h5Bish, -8, -50, 50, true);

	SetVal(a6Bish, 4, -50, 50, true);
	SetVal(b6Bish, 37, -50, 50, true);
	SetVal(c6Bish, 39, -50, 99, true);
	SetVal(d6Bish, 25, -50, 99, true);
	SetVal(e6Bish, 25, -50, 99, true);
	SetVal(f6Bish, 39, -50, 99, true);
	SetVal(g6Bish, 37, -50, 50, true);
	SetVal(h6Bish,  4, -50, 50, true);

	SetVal(a7Bish, -5, -50, 50, true);
	SetVal(b7Bish,-15, -50, 50, true);
	SetVal(c7Bish,  9, -50, 99, true);
	SetVal(d7Bish, -12, -50, 99, true);
	SetVal(e7Bish, -12, -50, 99, true);
	SetVal(f7Bish,  9, -50, 99, true);
	SetVal(g7Bish, -15, -50, 50, true);
	SetVal(h7Bish,  -5, -50, 50, true);

	SetVal(a8Bish, -31, -150, 50, true);
	SetVal(b8Bish, -42, -50, 50, true);
	SetVal(c8Bish, -26, -50, 50, true);
	SetVal(d8Bish, -48, -50, 50, true);
	SetVal(e8Bish, -48, -50, 50, true);
	SetVal(f8Bish, -26, -50, 50, true);
	SetVal(g8Bish, -42, -50, 50, true);
	SetVal(h8Bish, -31, -150, 50, true);
